...
import (
	...
	"github.com/livinjusttodie/greenlight/internal/jsonlog"
	"github.com/livinjusttodie/greenlight/internal/mailer"
)
...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "db-dsn", "postgres://postgres:1@localhost:5432/postgres?sslmode=disable", "PostgreSQL DSN")
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "211377@astanait.edu.kz", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "Aitu2021!", "SMTP password")
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Greenlight <211377@astanait.edu.kz>", "SMTP sender")
